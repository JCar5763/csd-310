...
def show_books(_cursor):
    # inner join query and get results from cursor - next two lines
...
try:
    ...
    # while/if statements depending on what the user clicks (not 4)
    while user_selection != 4:
        ...
        if user_selection == 3:
            ...
            # while/if statements depending on what the user clicks (not 3)
            while account_option != 3:
                ...
                # if statement for the user picking an option that is not valid (like 8) 
